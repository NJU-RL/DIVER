...
# export MODEL_PATH="/mnt/petrelfs/share_data/yanjianhao/Llama-3.1-8B-yuchen-sys"
# export MODEL_PATH="/mnt/petrelfs/share_data/yanjianhao/Llama-3.1-8B-Instruct-ds"
# srun -p ai_moe -c 64 -w SH-IDC1-10-140-37-29 \
srun -p ai_moe -c 70 -w SH-IDC1-10-140-37-118 \
 scripts/train/baseline_passk.sh --model $MODEL_PATH
