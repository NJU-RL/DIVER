...
from deepscaler_copy.data.utils import load_dataset
from deepscaler_copy.data.dataset_types import TrainDataset, TestDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default=os.path.expanduser('./deepscaler/dataset'),
