...
python3 -m verl.div_src.main_rl \
    ...
    data.train_files=/mnt/petrelfs/share_data/yanjianhao/v9/openr1_2k.parquet \
    ...
    +actor_rollout_ref.actor.rs_type='equ_warmup' \
    ...
    trainer.experiment_name='llama_equ_correct_0.1_40step' \
